                        ...
                        <Card className='p-3 rounded text-center shadow p-3 mb-5 bg-white' style={{ border: 'none' }}>
                            <Card.Body>
                                <Card.Text>
                                        ...
                                        {pokemonDetails.types.map(t => (
                                            <Col key={t.type.name}>
                                                <div className={`${t.type.name} rounded px-4 py-1`} style={{ color: 'white' }}>
                                                  <Link style={{color:'black'}} to={`/type/${t.type.name}`}>
                                    ...
                                    <Row className='mt-4'>
                                        <Col  xs={12} sm={12} md={12} lg={12} xl={12}>
                                            <div className='px-4 py-1 rounded' style={{ border: '1px black solid', backgroundColor:'#b3b3cb' }}>Abilities</div>
                                        </Col>
                                    </Row>
                                        ...
                                        {pokemonDetails.abilities.map(a => (
                                            <Col key={a.ability.name} xs={6} sm={6} md={6} lg={6} xl={6}>
                                                <div className={`rounded px-4 py-1`}>
                                                   <strong> {a.ability.name.toUpperCase()}</strong>
                                                </div>
                                            </Col>
                                        ))}
                                    </Row>
